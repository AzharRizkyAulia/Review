<?php 
    ...
    $jumlah = 1;
        ...
        elseif ($nama == "Nasi Goreng" || $nama == "nasi goreng" || $nama == "Nasi goreng"){
            $harga = 15000;
            $bayar = $jumlah * $harga;
            $diskon = $bayar * 20/100;
            $total = $bayar - ($bayar * (20/100));
    ...
    }   else if($nama == "Ayam Goreng" || $nama == "ayam goreng" || $nama == "Ayam goreng"){
            $harga = 20000;
            $bayar = $jumlah * $harga;
            $diskon = $bayar * 20/100;
            $total = $bayar - ($bayar * (20/100));
        ...
        if ($nama == "Air Mineral " || $nama == "air mineral" || $nama == "Air mineral"){
            $harga = 8000;
            $bayar = $jumlah * $harga;
            $diskon = $bayar * 20/100;
            $total = $bayar - ($bayar * (20/100));
